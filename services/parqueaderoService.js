...
const registrarAccesoVehicular = async (placa, tipo, tenantFilter, conjuntoId, usuarioLogueado) => {
    // Buscar residente o visitante por placa
    ...
    return { 
        acceso, 
        persona: residente ? `${residente.nombre} ${residente.apellido}` : `${visitante.nombreVisitante} ${visitante.apellidoVisitante}`,
...
const crearPlazasConjunto = async (conjuntoId, cantidadParam) => {
    ...
    // Verificar si el conjunto ya tiene plazas
