...
// 🔒 Advertencia de seguridad sobre JWT_SECRET
const JWT_SECRET = process.env.JWT_SECRET || 'secreto';
if (!process.env.JWT_SECRET || process.env.JWT_SECRET === 'secreto') {
    console.warn('⚠️ auth.middleware: JWT_SECRET no configurado o usando valor por defecto. Configure una clave segura en .env');
}
